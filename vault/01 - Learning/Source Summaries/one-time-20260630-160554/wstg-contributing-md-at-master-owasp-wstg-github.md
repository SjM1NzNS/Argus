...
compiled_at: 2026-06-30T14:09:49.103484+00:00
source_quality: 9
classification: Web2 skill update
vulnerability_class: AI / LLM Security
---

# wstg/CONTRIBUTING.md at master · OWASP/wstg · GitHub
...
- Notifications You must be signed in to change notification settings Fork 1.6k Star 9.5k Code Issues 34 Pull requests 7 Actions Models Security and quality 0 Insights Additional navigation options Code Issues Pull requests Actions Models Security and quality Insights Files Expand file tree master Breadcrumbs wstg / CONTRIBUTING.md Copy path Blame More file actions Blame More file actions Latest commit History History History 176 lines (110 loc) · 11.6 KB master Breadcrumbs wstg / CONTRIBUTING.md Copy path Top File metadata and controls Preview Code Blame 176 lines (110 loc) · 11.6 KB Raw Copy raw file Download raw file Outline Edit and raw actions Contributing to the Testing Guide Thank you for considering contributing to the Web Security Testing Guide (WSTG)!
- Create and switch to a new local branch with the name fix-<issue number> .
