...
compiled_at: 2026-06-30T08:31:42.052617+00:00
source_quality: 9
classification: Web2 skill update
vulnerability_class: AI / LLM Security
---

# ASVS/CONTRIBUTING.md at master · OWASP/ASVS · GitHub

- URL: `https://github.com/OWASP/ASVS/blob/master/CONTRIBUTING.md`
...
- Notifications You must be signed in to change notification settings Fork 815 Star 3.5k Code Issues 100 Pull requests 8 Discussions Actions Projects Models Wiki Security and quality 0 Insights Additional navigation options Code Issues Pull requests Discussions Actions Projects Models Wiki Security and quality Insights Files Expand file tree master Breadcrumbs ASVS / CONTRIBUTING.md Copy path Blame More file actions Blame More file actions Latest commit History History History 146 lines (97 loc) · 10.7 KB master Breadcrumbs ASVS / CONTRIBUTING.md Copy path Top File metadata and controls Preview Code Blame 146 lines (97 loc) · 10.7 KB Raw Copy raw file Download raw file Outline Edit and raw actions Contributing Last Update: This document has been updated as of the v5.0.0 release in May 2025.
